...
public final class BarCharts {
     ...
     * @throws Exception
     */
    public static void createSampleBar(BarEntity entity) throws Exception
	{
     ...
     * @throws Exception
     */
    public static void createMuiltBar(BarEntity entity) throws Exception
	{
    ...
    public static void main(String[] args) throws Exception{
    	...
    	entity.setImageFilename("d:/");
    	createMuiltBar(entity);
    }
