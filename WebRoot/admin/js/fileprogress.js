function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		delLink.href="javascript:deletePic('"+ progressContainer.id + "');";
		
		
		var deleteBtn = document.createElement("img");
		deleteBtn.src=document.getElementById("apppath").value+"/admin/images/no.gif";
	 
		deleteBtn.border=0;
		deleteBtn.className = "deleteBar";
		delLink.appendChild(deleteBtn);
...
FileProgress.prototype.setSuccess = function (fileName,fileid) {
	...
	link.href="javascript:viewPic('"+ fileName+"','"+fileid+"');"
