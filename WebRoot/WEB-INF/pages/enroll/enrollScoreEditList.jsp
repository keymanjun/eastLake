...
<input type="hidden" id="pagerAction" name="pagerAction" value="enrollScoreAction!executeEdit.action">
...
$(function() {
	...
	function doEdit(nflag)
	{
		...
		var saction="enrollScoreAction!toEditPage.action?Ids="+svalue;
	...
	function doSubmit()
	{
		var saction="enrollScoreAction!executeEdit.action";
		document.forms[0].action=saction;
		document.forms[0].submit();		
	}
