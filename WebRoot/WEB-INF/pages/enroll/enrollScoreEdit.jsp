		                   ...
		                   <table width="99%" border="0" align="center" cellpadding="0" cellspacing="2" id="edittb">
		                   		<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
									...
									<td align="left" colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;
										<s:property value="enrollStudent.approveScoreComment"/>
									</td>
								</tr>
								<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							  ...
							  <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
							   ...
							   <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
								   <s:iterator value="majorScoreList" status="status">
										...
										<td  align="left">
										<s:hidden name="majorScoreList[%{#status.index}].id" value="%{majorScoreList[#status.index].id}"/>
											<s:hidden name="majorScoreList[%{#status.index}].enrollId" value="%{majorScoreList[#status.index].enrollId}"/>
...
<script language="javascript">
	...
	function doSubmit(flag)
	{
	  ...
	  document.forms[0].action="enrollScoreAction!saveEnrollScoreEdit.action";
	  document.forms[0].submit();
	}
	
	function toGoBack()
	{	
	  document.forms[0].action="enrollScoreAction!goBackEdit.action";
	  document.forms[0].submit();
	}
