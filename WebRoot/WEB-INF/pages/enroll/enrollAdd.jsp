      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right" valign="top" class="czmb_2">
            	<div class="tool" id="toolsBar" style="display:none">
                ...
                <tr>
                  <td>                  	
                  	<div style="padding-top:10px; padding-bottom:10px;">
							<p>
								<span>欢迎您报考武汉东湖学院，请仔细阅读以下注意事项：</span>
							</p>
							<p>
								<span >一、&nbsp;报名须知</span>
							</p>
							<p>
								<span>	（一）、招生对象：2017年湖北省普通高校普通全日制高职高专应届毕业生，
										包括普通本科院校、独立设置的高职高专院校、
										独立学院以及成人高校举办的普通全日制高职高专应届毕业生。</span>
							</p>
							<p>
								<span>（二）、报名条件：具有良好的思想品德和政治素质，热爱祖国，遵纪守法，
										在校期间未受任何纪律处分；修完普通高职高专教学计划规定的课程，
										成绩良好，能如期毕业；身体健康。</span>
							</p>
							<p>
								<span >（三）、报名填写信息必须真实准确。</span>
							</p>
							<p>
								<span >二、&nbsp;本系统仅为武汉东湖学院普通专升本考试报名专用，若有疑问请致电武汉东湖学院教务处（TEL:81931038）。</span>
							</p>
		                </div>
		                <table width="100%" border="0" cellpadding="0" cellspacing="0">
	                      <tr>
	                        <td align="center"><img src="<%=scontext%>/admin/images/tj.gif" width="22" height="21"><a href="#" onclick="doAgree()">我已阅读,并同意</a></td>
	                      </tr>
	                     </table>
		          </td>
                </tr>
            ...
            <div id="enrollInfo" style="display:none">
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="border_blue">
                <tr>
                  <td class="operate_title">
                  	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		                   ...
		                   <table width="99%" border="0" align="center" cellpadding="0" cellspacing="2" id="edittb">
								<tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
									...
									<td  width="15%" align="left" rowspan="6">&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<div><img id="uploadPreview" style="width:150px;height:180px" src="<%=scontext%>/pics/defaultImage.jpg"/></div>
							  ...
							  <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
									<td align="center">所在学校<font color="red">(*)</font></td>
									<td align="left" colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;
							  ...
							  <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
									<td align="center">所在学校代码<font color="red">(*)</font></td>
							  ...
							  <!-- tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
									...
									<td  align="left" colspan="6">&nbsp;&nbsp;&nbsp;&nbsp;
									<s:textfield id="targetMajorCode" name="targetMajorCode" cssClass="mytext" theme="simple" size="80" readonly="true" maxlength="20"/>	
									</td>
							  </tr-->
							  <tr align="center" onmouseout="reChangeBackground(this)" onmouseover="changeBackground(this)">
              ...
              <div class="tool" id="toolsBarTwo" style="display:none">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="70" style="cursor:hand" onMouseOver="this.style.backgroundImage='url(images/tool_bg1.gif)';this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#DFAF0D'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'">
                  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
...
<script language="javascript">
	...
	function validTextValue()
	{
	  ...
	  if(getElem("uploadImage").value.trim().length<1){
	     	sMsg+="登记照不能为空。\n";
	  }
	...
	function doAgree(){
		getElem("preNote").style.display="none";
		getElem("enrollInfo").style.display="block";
		getElem("toolsBar").style.display="block";
		getElem("toolsBarTwo").style.display="block";
	}
