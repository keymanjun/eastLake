...
<input type="hidden" id="pagerAction" name="pagerAction" value="enrollScoreAction!executeApprove.action">
...
$(function() {
	...
	function doSubmit()
	{
		var saction="enrollScoreAction!executeApprove.action";
		document.forms[0].action=saction;
		document.forms[0].submit();		
	}
