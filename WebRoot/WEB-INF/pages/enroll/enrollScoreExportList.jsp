...
<input type="hidden" id="pagerAction" name="pagerAction" value="enrollScoreAction!executeExport.action">
                  	...
                  	<div id="listdiv" class="listdiv">
	                  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		                    <tr align="center">
							  ...
							  <td class="list_title" nowrap width="5%"><a href=# onclick="javascript:orderBy('enrollScoreAction','scoreStatus');">分数状态<br></a></td>
						    ...
						    <s:iterator value="#request.pagerResult.items" id="pageResult" status="status">					    		  
							      ...
							      <td class="list_content" nowrap bgcolor="#FFFFFF">&nbsp;<s:property value="scoreStatusName"/></td>
...
function doExport()
{
	...
	if(confirm("是否导出学生的报名标签?")){
		var saction="enrollScoreAction!exportEnroll.action";
...
$(function() {
	...
	function doEdit(nflag)
	{
		...
		var saction="enrollScoreAction!toApprovePage.action?Ids="+svalue;
		document.forms[0].action=saction;
		document.forms[0].submit();
	}
	...
	function doSubmit()
	{
		var saction="enrollScoreAction!executeExport.action";
		document.forms[0].action=saction;
		document.forms[0].submit();	
	}
