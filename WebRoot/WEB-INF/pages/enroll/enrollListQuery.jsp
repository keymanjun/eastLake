...
<input type="hidden" id="pagerAction" name="pagerAction" value="enrollApproveAction!loadEnrollList.action">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" bgcolor="DEE8F6" class="right">
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" bgcolor="#FFFFFF" class="spec_title">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" >
					<tr height="22">
						...
						<td width="10%">状态:</td>
						<td width="15%"><s:select id="enrollStatus" label="enrollStatus" name="enrollStudent.enrollStatus" headerKey="-1" headerValue="请选择"
								   			list="#request.enrollStatush" theme="simple" style="width:150px"/></td>
						<td width="10%">联系电话:</td>
						<td width="15%"><s:textfield id="phone" name="enrollStudent.phone" cssClass="mytext" theme="simple"/></td>		   			
					</tr>
					<tr height="22">	   
						<td width="100%" align="right" colspan="8">
							<div class="search">
								<a href="#" onclick="doSubmit()"><img src="<%=scontext%>/admin/images/search.gif" width="60" height="20" border="0"></a>
							</div>
						</td>
					</tr>
              </table>
                  	...
                  	<div id="listdiv" class="listdiv">
	                  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		                    <tr align="center">
							  ...
							  <td class="list_title" nowrap width="10%"><a href=# onclick="javascript:orderBy('enrollAction','identify');">身份证<br></a></td>
						    ...
						    <s:iterator value="#request.pagerResult.items" id="pageResult" status="status">					    		  
							      ...
							      <br></td>
							      <td class="list_content" nowrap >&nbsp;<a href="javascript:popupDetail('<s:property value="id"/>')"><s:property value="no"/></a></td>
							      <td class="list_content" nowrap >&nbsp;<a href="javascript:popupDetail('<s:property value="id"/>')"><s:property value="name"/></a></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="enrollStatusName"/></td>
							      <td class="list_content" nowrap >&nbsp;<a href="javascript:popupDetail('<s:property value="id"/>')"><s:property value="identify"/></a></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="email"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="politicalType"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="phone"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="schoolName"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="major"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="targetMajor"/></td>
							      <td class="list_content" nowrap >&nbsp;<s:property value="commitDate"/></td>
								</tr>
				            </s:iterator>
	                  	</table>
                    </div>
...
$(function() {
	...
	function doSubmit()
	{
		var saction="enrollApproveAction!loadEnrollList.action";
		document.forms[0].action=saction;
		document.forms[0].submit();	
	}
